...
CREATE TABLE Customers(CustomerID INT NOT NULL UNIQUE PRIMARY KEY, 
...
CREATE TABLE Employees(EmployeeID INT NOT NULL UNIQUE PRIMARY KEY, 
FirstName VARCHAR(50) NOT NULL, 
LastName VARCHAR(50) NOT NULL, 
Phone VARCHAR(30), 
Email VARCHAR(100), 
...
CREATE TABLE Orders(OrderID INT NOT NULL UNIQUE PRIMARY KEY, 
