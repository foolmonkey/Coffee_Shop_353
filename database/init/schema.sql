...
CREATE TABLE Orders(OrderID VARCHAR(255) NOT NULL PRIMARY KEY, 
...
-- populating tables
INSERT INTO Menu (ItemName, Category, Price, Description) 
VALUES 
("Brewed Coffee", "Drinks", 4.50, "With your choice of Medium, Dark, or Decaf."),
("Cappuccino", "Drinks", 4.50, "Freshly brewed."),
("Americano", "Drinks", 2.50, "Espresso topped with hot water."),
("Latte", "Drinks", 4.00, "Oh sweet morning cup."),
("London Fog", "Drinks", 4.20, "Earl Grey tea, milk, and vanilla syrup."),
("Tea", "Drinks", 2.50, "Early morning zen, in many varieties."),
